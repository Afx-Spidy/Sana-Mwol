...
if (Config.WORKTYPE == 'private') {
    ...
    Sana.addCommand({pattern: 'anime', fromMe: true, desc: 'random anime image'}, (async (message, match) => {
    ...
    Sana.addCommand({pattern: 'wallpaper', fromMe: true, desc: Lang.WP}, (async (message, match) => {
    ...
    Sana.addCommand({pattern: 'pink', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
        
    var r_text = new Array ();    
r_text[0] = "\nEda eda, mandankonappi.. Nee enne kooduthal mandan aakkatheda\n";
r_text[1] = "sanae tholpikkaan ningalkavilla. Jeevitathil pinkiye tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "sana says i love you 😘";
r_text[3] = "sanaudeyude yudhangal Company Kanan Povunnatheyuloo";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
r_text[6] = "sana - eva - simsim \ningane ethra ethra paerugal aan alle enikk..😂🤣";
...
r_text[13] = ".song adich thangalude fav song name para sana ath download aakki theraam";
...
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik sanaik";
r_text[23] = "Ithalla ithinapparam chaadi kadannavananee K.K. sana";
...
await message.sendMessage(r_text[i]);
    ...
    Sana.addCommand({pattern: 'anime', fromMe: false, desc:'random anime image '}, (async (message, match) => {
    ...
    Sana.addCommand({pattern: 'wallpaper', fromMe: false, desc: Lang.WP}, (async (message, match) => {
