...
if (conf.WORKTYPE == 'private') {
    ...
    Sana.addCommand({ pattern: 'voicy', desc: Lang.USAGE, fromMe: true }, (async (message, match) => {
...
if (conf.WORKTYPE == 'public') {
    ...
    Sana.addCommand({ pattern: 'voicy', desc: Lang.USAGE, fromMe: false }, (async (message, match) => {
